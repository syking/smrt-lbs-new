...
public class Events extends Controller {
    ...
    public static void list(String vehicleNo){
    	...
    	List<EventVO> eventVOList = EventService.assemEventVO(v);
    	if (eventVOList == null)
    		viewOnMap();
    ...
    public static void gps(String vehicleNo, Long eventId){
    	...
    	renderJSON(EventService.findGPS(vehicleNo));
    }
    ...
    /**
     * Search for events
     * @param driver driver_id
     * @param serviceNo line
     * @param type  event_type_tech_name
     * @param startTime
     * @param endTime
     */
